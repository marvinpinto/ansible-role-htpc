...
ln -fTs /vagrant /opt/ansible_roles/ansible-role-htpc
ln -fTs /vagrant /opt/ansible_roles/marvinpinto.htpc
ansible-galaxy install -r /vagrant/galaxy-roles.yml -p /opt/ansible_roles
SCRIPT
